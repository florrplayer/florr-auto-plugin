...
- Lazy Theta\* pathing with updated 1.20 maps (Ant Hell / Desert / Ocean, shortcuts walkable)
- Patrol mode: cycle through user-defined waypoints
- Combat mode: hunt Mythic (cyan) mobs, keep 3px distance, auto attack with right-click
- Ultra (pink) avoidance: 5px avoidance, 0.5px kiss-then-retreat fallback
...
```bat
py -3.12 main.py desert    :: desert map (anthell / ocean also available)
